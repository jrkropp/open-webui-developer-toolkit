...
6. If tools exist but the model record isn't `function_calling: "native"`, update the
   record in the DB (`Models.update_model_by_id`) and notify the user to re-run.
